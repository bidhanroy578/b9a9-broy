...
const Details = () => {
    ...
    return (
        <div className="space-y-8">
            <div className="min-h-screen grid md:grid-cols-2 gap-2 relative">
                ...
                <div className="md:absolute bottom-[10%] left-[10%] z-10 text-xl">
                ...
                <button className="md:absolute bottom-[10%] right-[10%] z-10 btn btn-lg rounded-full ">See More </button>
            </div>
